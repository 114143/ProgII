...
namespace CARRERASAPP.Datos
{
    internal class DBHelper
    {
        ...
        public DBHelper()
        {
            conexion = new SqlConnection(@"Data Source=DESKTOP-GIS1JVG\SERVIDORSQL;Initial Catalog=CarrerasBD_Local;Integrated Security=True");
        }
        ...
        public bool ConfirmarAsignatura(Carrera oCarrera)
        {
            ...
            try
            {
                ...
                comando.Parameters.AddWithValue("@id_carrera", oCarrera.Id_Carrera);
