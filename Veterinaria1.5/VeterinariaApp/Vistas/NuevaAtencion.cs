...
namespace VeterinariaApp.Vistas
{
    public partial class fmrNuevaAtencion : Form
    {
        ...
        private void CargarDescripcion()//tipo de animal
        {
            ...
            conexion.ConnectionString = @"Data Source=DESKTOP-GIS1JVG\SERVIDORSQL;Initial Catalog=Veterinaria_2023;Integrated Security=True";
            conexion.Open();
            ...
            cboDescripcionAtencion.DataSource = tabla;//es el tipo (descripcion)
            cboDescripcionAtencion.ValueMember = tabla.Columns[0].ColumnName;//o se puede escribir "id_producto"
            cboDescripcionAtencion.DisplayMember = tabla.Columns[1].ColumnName;// "n_producto"
        }
